        ...
        <div class="row">
            @foreach($ranges as $key => $rangeData)
                <div class="custom-col">
                    <div class="card card-hover p-1 @if($loop->last) active @endif" id="card{{$key}}"
            ...
            <table class="table table-striped" id="table">
                ...
                @foreach($dateArrays as $key => $date)
                    ...
                    <tr class="{{$tr_bg}} {{$ot_bg}}">
                        ...
                        <td class="{{$tr_bg}} {{$ot_bg}}">Approved Hours<br><strong>{{ $approved_hours }}</strong>
                        </td>
                        <td class="{{$tr_bg}} {{$ot_bg}}">Rejected Hours<br><strong>{{ $rejected_hours }}</strong>
                        </td>
